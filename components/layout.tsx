...
const Layout = ({title, children, breadcumb}:Props) => {
        ...
        <div>
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M7.61872 0.256282C7.27701 -0.0854272 6.72299 -0.0854272 6.38128 0.256282L0.256282 6.38128C-0.0854272 6.72299 -0.0854272 7.27701 0.256282 7.61872C0.59799 7.96043 1.15201 7.96043 1.49372 7.61872L1.75 7.36244V13.125C1.75 13.6082 2.14175 14 2.625 14H4.375C4.85825 14 5.25 13.6082 5.25 13.125V11.375C5.25 10.8918 5.64175 10.5 6.125 10.5H7.875C8.35825 10.5 8.75 10.8918 8.75 11.375V13.125C8.75 13.6082 9.14175 14 9.625 14H11.375C11.8582 14 12.25 13.6082 12.25 13.125V7.36244L12.5063 7.61872C12.848 7.96043 13.402 7.96043 13.7437 7.61872C14.0854 7.27701 14.0854 6.72299 13.7437 6.38128L7.61872 0.256282Z" fill="#06A9B1"/>
            </svg> 
            <span className="text-xs text-green-500 mx-2 my-2">Home</span>
            <span className="text-xs text-gray-500">/ {breadcumb}</span>
          </div>
        </div>
